...
|[Static_Config_Studio_Automation](Static_Config_Studio_Automation) | Automate getting, setting configlets from Static Configuration Studio and also migrate reconcile configlets to normal configlets | 
